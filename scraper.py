...
def scraper(symbol: str, stock_name: str):
    ...
    URL = f"https://www.macrotrends.net/stocks/charts/ROP/roper-technologies/income-statement?freq=Q"
    ...
    # making sure it doesn't get stuck
    # threat = threading.Thread(target=get_url, args=(driver, URL))
    # threat.start()
    # threat.join(timeout=2)
    get_url(driver, URL)
    ...
    operatin_exp = filter_operating_expenses(html)
